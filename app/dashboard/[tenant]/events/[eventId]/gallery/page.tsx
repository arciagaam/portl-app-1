...
import { GallerySection } from '@/components/dashboard/events/gallery-section';
...
export default async function GalleryPage({
  ...
  if (!user) {
    redirect(`/auth/signin?callbackUrl=/dashboard/${subdomain}/events/${eventId}/gallery`);
  }
  ...
  return (
    <div className="container mx-auto px-6 py-8 max-w-7xl space-y-6">
      ...
      {/* Gallery Section */}
      <GallerySection event={event} tenantSubdomain={subdomain} />
    </div>
  );
}
