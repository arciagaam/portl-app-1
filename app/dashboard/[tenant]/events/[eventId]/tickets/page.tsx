...
import { TicketsSection } from '@/components/dashboard/events/tickets-section';
...
export default async function TicketsPage({
  ...
  if (!user) {
    redirect(`/auth/signin?callbackUrl=/dashboard/${subdomain}/events/${eventId}/tickets`);
  }
  ...
  return (
    <div className="container mx-auto px-6 py-8 max-w-7xl space-y-6">
      ...
      {/* Tickets Section */}
      <TicketsSection event={event} tenantSubdomain={subdomain} />
    </div>
  );
}
