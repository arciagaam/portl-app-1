...
import { PromotionsSection } from '@/components/dashboard/events/promotions-section';
...
export default async function PromotionsPage({
  ...
  if (!user) {
    redirect(`/auth/signin?callbackUrl=/dashboard/${subdomain}/events/${eventId}/promotions`);
  }
  ...
  return (
    <div className="container mx-auto px-6 py-8 max-w-7xl space-y-6">
      ...
      {/* Promotions Section */}
      <PromotionsSection event={event} tenantSubdomain={subdomain} />
    </div>
  );
}
